...
public class NumbersActivity1 extends AppCompatActivity implements View.OnTouchListener {
    ImageView bt_start;
    TextView text1;
    TextView text2;
    TextView text3;
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (view.getId()) {
            case R.id.imageView8:
                ...
                if (s2.toLowerCase(Locale.ROOT).equals("биир")) {
                text3.setText("Собир. "+s1.SobirNumbers(s2, 1));}
                else {text3.setText("Собир. "+s1.SobirNumbers(s2, 1) + "(н)");}
